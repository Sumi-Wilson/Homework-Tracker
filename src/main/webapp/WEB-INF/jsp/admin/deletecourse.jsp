        ...
        <div class="row justify-content-center">
            <div class="col-6">
               ...
               <c:if test="${not empty successMessage}">
                ...
                <form method="get" action = "/admin/deletecourseSubmit" style="padding-bottom: 10px; padding-left: 15px; padding-right: 15px; border: 1px solid #ccc; border-radius: 10px; background-color: #F2FAFF;">
